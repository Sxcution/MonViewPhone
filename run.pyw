    ...
    try:
        ...
        if not passed:
            err_msg = (
                ...
                f"- tileOrder: {'HỢP LỆ' if tile_order_ok else 'KHÔNG HỢP LỆ'} (Số lượng: {tile_order_count}/35)\n"
                f"- tileOrderNumbers: {'HỢP LỆ' if tile_order_numbers_ok else 'KHÔNG HỢP LỆ'} (Số lượng: {tile_order_numbers_count}/35)\n\n"
