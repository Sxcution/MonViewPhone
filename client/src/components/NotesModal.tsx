...
import { AnchoredPopover, ConfirmDialog, ModalLayer } from '@/components/ui';
...
export function NotesModal({ initialNoteId, onClose }: NotesModalProps) {
  ...
  // Button refs for AnchoredPopover
  ...
  useEffect(() => {
    ...
    setCountdownHours('');
    setCountdownMinutes('');
  }, [activeNoteId, reminderPopoverOpen, activeNote]);
  ...
  return (
    <>
                ...
                <div className="notesContentHeader">
                  ...
                  <div className="notesToolbar">
                    ...
                    <div>
                      ...
                      <AnchoredPopover
                        isOpen={reminderPopoverOpen}
                        onClose={() => setReminderPopoverOpen(false)}
                        anchorEl={reminderBtnRef.current}
                    ...
                    <div>
                      ...
                      <AnchoredPopover
                        isOpen={fontSizePopoverOpen}
                        onClose={() => setFontSizePopoverOpen(false)}
                        anchorEl={fontSizeBtnRef.current}
                        placement="bottom-end"
      ...
      <ConfirmDialog
        ...
        variant="danger"
        onConfirm={() => {
          if (deleteConfirmNoteId) handleDeleteNote(deleteConfirmNoteId);
