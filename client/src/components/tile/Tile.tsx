...
function TileComponent({
    ...
    // Keep this synchronous so a parent-triggered reload immediately uses the
    // just-rendered viewer/global config instead of waiting for child effects.
        ...
        >
            ...
            <div className="tileBody" ref={bodyRef}>
                {isDisconnected && !showAccountOverlay ? (
                    ...
                    <>
                        {!isViewing && showLoadingOverlay && !showAccountOverlay ? (
                        ...
                        {showTileInfo && streamStats && (
                            <div className="stream-debug-overlay">
                                ...
                                <div>Decoder: {streamStats.decoderName || 'unknown'}</div>
