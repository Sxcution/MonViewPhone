...
const legacyViToEn: Record<string, string> = {
  ...
  'Mở rộng cấu hình Stream': 'Expand stream config',
  'Thu nhỏ cấu hình Stream': 'Collapse stream config',
  'Mở rộng điều khiển nhanh': 'Expand quick controls',
  'Thu nhỏ điều khiển nhanh': 'Collapse quick controls',
  'Reset cấu hình Stream về mặc định': 'Reset stream config to default',
