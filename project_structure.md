...
- [NEW] [DeviceAccountOverlay.tsx](file:///c:/Users/Mon/Desktop/Protect/MonViewPhone/client/src/components/DeviceAccountOverlay.tsx): Standalone full-screen account manager overlay for connected devices. Supports adding/viewing/modifying social media accounts (WeChat, Line, Tantan, Zalo, etc.) mapped per device UDID.
